<?php include('header.php'); ?>
      ...
      <div id="content">
        <div class="section">
          ...
          <p>I don't always have need to use an engine like Wordpress, Joomla, Django, or any other of the great open source website frameworks that you can download because not everything needs to be database driven or have user accounts, replies, and tags.</p>
